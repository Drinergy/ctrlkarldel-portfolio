        ...
        <div className="rounded-3xl bg-white/[0.02] p-4 sm:p-6 md:p-10 print:rounded-none print:bg-white print:p-0 print:text-black print:shadow-none">
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <div className="mt-2 font-mono text-[13px] tracking-[0.22em] text-foreground/70 print:text-black md:text-[14px]">
                {header.title.toUpperCase()}
              </div>

              <div className="mt-5 space-y-1 font-mono text-[13px] tracking-[0.12em] text-foreground/70 print:text-black md:text-[14px]">
          ...
          <div className="mt-8 grid gap-10 md:grid-cols-12 print:grid-cols-1 print:gap-6">
            <div className="md:col-span-7">
              ...
              <div className="mt-3 font-mono text-[13px] leading-relaxed tracking-[0.12em] text-foreground/70 print:text-[11px] print:leading-[1.45] print:tracking-[0.04em] print:text-black md:text-[14px]">
                {summary}
              </div>
                ...
                <div className="mt-5 space-y-6 print:space-y-4">
                  {experience.map((item) => (
                    ...
                    >
                      ...
                      <div className="mt-2 font-mono text-[13px] tracking-[0.16em] text-foreground/70 print:text-[11px] print:tracking-[0.05em] print:text-black md:text-[14px]">
                        {item.role}
                      </div>
                      <ul className="mt-3 space-y-2 print:space-y-1.5">
                        {item.bullets.map((b) => (
                          <li
                            key={b}
                            className="font-mono text-[13px] leading-relaxed tracking-[0.12em] text-foreground/70 print:text-[11px] print:leading-[1.4] print:tracking-[0.04em] print:text-black md:text-[14px]"
                          >
                            - {b}
                          </li>
                        ))}
