      ...
      <div className="mx-auto w-full min-w-0 max-w-6xl">
        <div className="grid min-w-0 gap-12 lg:grid-cols-12 lg:items-end lg:gap-10">
          ...
          <div className="min-w-0 lg:col-span-5">
            <div
              ref={mediaRef}
              className="relative aspect-[4/5] w-full max-md:portrait:min-h-[520px] overflow-hidden rounded-3xl border border-white/10 bg-surface/60 max-h-[min(84svh,640px)] max-md:landscape:max-h-[min(70svh,480px)] lg:max-h-none"
            >
              <div
                aria-hidden="true"
